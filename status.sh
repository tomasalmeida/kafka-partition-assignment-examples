...
cd tooling
java -cp  target/partitioning-tool-1.0.0-SNAPSHOT-jar-with-dependencies.jar  partitioning.tool.kafka.admin.ConsumerGroupStatus config.properties $CONSUMER_GROUP